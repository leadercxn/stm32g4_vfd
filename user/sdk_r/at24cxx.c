...
#elif (_EEPROM_SIZE_KBIT == 128) || (_EEPROM_SIZE_KBIT == 256)
#define _EEPROM_PSIZE     64
#elif (_EEPROM_SIZE_KBIT == 512)
#define _EEPROM_PSIZE     128
#else 
#define _EEPROM_PSIZE     32
#endif

static uint8_t m_at24_lock = 0;
...
{
  const uint8_t eraseData[32] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
